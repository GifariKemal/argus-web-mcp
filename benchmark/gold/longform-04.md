<!-- INDEPENDENT gold (P2 Task 8, re-curated 2026-06-24). Source: https://www.paulgraham.com/greatwork.html | NEUTRAL method: BeautifulSoup .get_text() over the <font> main-text block (bs4 plain DOM text-dump). Independent of Argus (trafilatura) AND of the readability baseline - no article-detection heuristic, favours no adapter. -->
July 2023

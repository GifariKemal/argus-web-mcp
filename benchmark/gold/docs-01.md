<!-- INDEPENDENT gold (P2 Task 8, re-curated 2026-06-24). Source: https://fastapi.tiangolo.com/tutorial/first-steps/ | NEUTRAL method: BeautifulSoup .get_text() over the <article> doc body node (bs4 plain DOM text-dump). Independent of Argus (trafilatura) AND of the readability baseline - no article-detection heuristic, favours no adapter. -->
First Steps
...
--entrypoint
main:app
But you would have to remember to pass the correct path\entrypoint every time you call the
fastapi
command.
